...
class LineChartWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LineChart(isShowingMainData ? sampleData1 : sampleData2, duration: const Duration(milliseconds: 250));
  }
  ...
  List<LineChartBarData> get lineBarsData1 => [lineChartBarData1_1, lineChartBarData1_2, lineChartBarData1_3];
  ...
  List<LineChartBarData> get lineBarsData2 => [lineChartBarData2_1, lineChartBarData2_2, lineChartBarData2_3];
  ...
  LineChartBarData get lineChartBarData1_3 => LineChartBarData(
    ...
    dotData: const FlDotData(show: false),
    belowBarData: BarAreaData(show: false),
    spots: const [FlSpot(1, 2.8), FlSpot(3, 1.9), FlSpot(6, 3), FlSpot(10, 1.3), FlSpot(13, 2.5)],
  );
  ...
  LineChartBarData get lineChartBarData2_3 => LineChartBarData(
    ...
    belowBarData: BarAreaData(show: false),
    spots: const [FlSpot(1, 3.8), FlSpot(3, 1.9), FlSpot(6, 5), FlSpot(10, 3.3), FlSpot(13, 4.5)],
  );
}
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              ...
              const Text(
                'Monthly Sales',
                style: TextStyle(color: primary, fontSize: 32, fontWeight: FontWeight.bold, letterSpacing: 2),
