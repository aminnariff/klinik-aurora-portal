...
//   final String type;
//   const VoucherDetail({super.key, this.user, required this.type});
...
//       _voucherName.text = widget.user?.voucherName ?? '';
//       _voucherDescription.text = widget.user?.voucherDescription ?? '';
//       _voucherCode.text = widget.user?.voucherCode ?? '';
...
//                                       labelText: 'information'.tr(gender: 'vouchername'),
//                                     ),
//                                   ),
//                                   AppPadding.vertical(denominator: 2),
//                                   InputField(
...
//                                       userDob: convertStringToDate(_userDob.text),
