      ...
      children: [
        SingleChildScrollView(
          child: Column(
            ...
            mainAxisSize: MainAxisSize.min,
            children: [
              Consumer<DoctorController>(builder: (context, snapshot, _) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: (snapshot.doctorBranchResponse != null &&
                                                        ...
                                                        onPressed: () async {
                                                          try {
                                                            if (await showConfirmDialog(
                                                                context,
                                                                snapshot.doctorBranchResponse?.data?[index]
                                                                            .doctorStatus ==
                                                                        1
                                                              ...
                                                              Future.delayed(Duration.zero, () {
                                                                DoctorController.update(
                                                                  ...
                                                                  UpdateDoctorRequest(
                                                                    doctorId: snapshot
                                                                        .doctorBranchResponse?.data?[index].doctorId,
                                                                    branchId: snapshot
                                                                        .doctorBranchResponse?.data?[index].branchId,
                                                                    doctorPhone: snapshot
                                                                        .doctorBranchResponse?.data?[index].doctorPhone,
                                                                    doctorName: snapshot
                                                                        .doctorBranchResponse?.data?[index].doctorName,
                                                                    doctorStatus: snapshot.doctorBranchResponse
                                                                  ...
                                                                  if (responseCode(value.code)) {
                                                                    DoctorController.get(context, 1, pageSize,
                                                                      ...
                                                                      if (responseCode(value.code)) {
                                                                        ...
                                                                        showDialogSuccess(
                                                                            context, 'Successfully updated new PIC');
                                                                      } else {
                                                                        showDialogSuccess(
                                                                            context, 'Successfully updated new PIC');
                                                                      }
