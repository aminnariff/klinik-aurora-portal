...
class UserController extends ChangeNotifier {
  ...
  static Future<ApiResponse<UserAllResponse>> getAll(
    ...
    return ApiController()
        ...
        .then((value) {
          try {
            return ApiResponse(code: value.code, data: UserAllResponse.fromJson(value.data));
          } catch (e) {
  ...
  static Future<ApiResponse<UserAppointmentResponse>> appointment(BuildContext context, String userId) async {
    return ApiController()
        .call(
          context,
          method: Method.get,
          endpoint: 'admin/user-management/appointment',
  ...
  static Future<ApiResponse<UpdateUserResponse>> update(BuildContext context, UpdateUserRequest request) async {
    return ApiController()
        .call(context, method: Method.put, endpoint: 'admin/user-management/update', data: request.toJson())
        .then((value) {
          try {
            return ApiResponse(code: value.code, data: UpdateUserResponse.fromJson(value.data));
          } catch (e) {
            return ApiResponse(code: 400, message: e.toString());
          }
        });
  ...
  static Future<ApiResponse<CreateUserResponse>> create(BuildContext context, CreateUserRequest request) async {
    return ApiController()
        .call(context, method: Method.post, endpoint: 'admin/user-management/create', data: request.toJson())
        .then((value) {
          try {
            return ApiResponse(code: value.code, data: CreateUserResponse.fromJson(value.data));
          } catch (e) {
            return ApiResponse(code: 400, message: e.toString());
          }
        });
