...
class DoctorController extends ChangeNotifier {
  ...
  static Future<ApiResponse<DoctorBranchResponse>> get(
    ...
    return ApiController()
        ...
        .then((value) {
          try {
            return ApiResponse(code: value.code, data: DoctorBranchResponse.fromJson(value.data));
          } catch (e) {
  ...
  static Future<ApiResponse<UpdateDoctorResponse>> update(BuildContext context, UpdateDoctorRequest request) async {
    return ApiController()
        .call(context, method: Method.put, endpoint: 'admin/doctor/update', data: request.toJson())
        .then((value) {
          try {
            return ApiResponse(code: value.code, data: UpdateDoctorResponse.fromJson(value.data));
          } catch (e) {
            return ApiResponse(code: 400, message: e.toString());
          }
        });
  ...
  static Future<ApiResponse<CreateDoctorResponse>> create(BuildContext context, CreateDoctorRequest request) async {
    return ApiController()
        .call(context, method: Method.post, endpoint: 'admin/doctor/create', data: request.toJson())
        .then((value) {
          try {
            return ApiResponse(code: value.code, data: CreateDoctorResponse.fromJson(value.data));
          } catch (e) {
            return ApiResponse(code: 400, message: e.toString());
          }
        });
  ...
  static Future<ApiResponse<UpdateDoctorResponse>> upload(
    ...
    try {
      return dio
          ...
          .then((value) {
            try {
              return ApiResponse(code: value.statusCode, data: UpdateDoctorResponse.fromJson(value.data));
            } catch (e) {
              return ApiResponse(code: 400, message: e.toString());
            }
          });
