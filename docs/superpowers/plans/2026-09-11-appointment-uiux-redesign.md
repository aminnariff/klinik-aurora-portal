...
- [ ] **Step 1: Consolidate `_buildBranchBar` and `_buildDateFilterBar` into single unified toolbar**
...
- [ ] **Step 1: Add prominent status banner & quick actions in modal header**
...
- [ ] **Step 2: Implement responsive 2-column layout for desktop**
  - For `!isMobile`:
...
- [ ] **Step 3: Quick status action handlers**
